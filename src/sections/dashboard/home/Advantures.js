          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="breadcrumb-contents">
                <h4 className="breadcrumb-contents-title">Adventure</h4>
                <ul className="breadcrumb-contents-list list-style-none">
                  ...
                  <li className="breadcrumb-contents-list-item">Adventure</li>
                </ul>
              </div>
            </div>
          </div>
...
export default AdvantureDashboard;
